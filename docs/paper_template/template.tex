...
% TODO: Обновить таблицу финальными данными с доверительными интервалами.
...
% TODO: Провести статистический тест (Mann-Whitney U) для подтверждения значимости различий после получения достаточного числа прогонов.
