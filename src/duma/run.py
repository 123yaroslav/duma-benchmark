...
from duma.registry import RegistryInfo, registry
from duma.user.user_simulator import DummyUser, get_global_user_sim_guidelines
...
def run_tasks(
    ...
    ConsoleDisplay.console.print(
        ...
        "To review the simulations, run: [bold blue]duma view[/bold blue]"
    )
    return simulation_results
